...
const Careers: React.FC<LocationProps> = ({ location }) => {
  return (
    <Layout location={location} className="px-0 mx-0 overflow-hidden">
      <CareersLayout
        isApplySectionApplicable={false}
        sectionTitle={'Apply for following available positions with Eumentis Informatics Pvt. Ltd.'}
        children={
          <section>
            <div className="career-section-heading text-center pt-2 pb-4 text-dark">
              Available positions
            </div>
