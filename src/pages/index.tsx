...
import BioInformaticsLogo from '../images/svgAssets/bioinformatics.svg';
    ...
    <Layout location={location}>
      <div className="container index-main-content">
        ...
        <section id="services" className="row no-gutters">
          ...
          <ServicesCard
            hasExternalLink
            externalURL="https://bioinfo.eumentis.com"
            title={'Bioinformatics'}
            description={'Bioinformatics as-a-service'}
            img={<BioInformaticsLogo />}
          />
          <ServicesCard
