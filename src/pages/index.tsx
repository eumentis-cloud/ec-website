      ...
      <Layout location={location}>
        <div className="container index-main-content">
          ...
          <section className="container-fluid position-sticky py-3">
              ...
              <Swiper id="main" loopPreventsSlide={false} loop centeredSlides autoplay={{delay: 1500, disableOnInteraction: false}} slidesPerView={5} spaceBetween={60} preloadImages breakpoints={{
                  320: {
                      slidesPerView: 1,
                  },
                  480: {
