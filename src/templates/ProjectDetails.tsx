...
const ProjectDetails: React.FC<ProjectDetailsProps> = ({ location, pageContext }) => {
  ...
  const {
    file,
    allClientsDataCsv,
  }: SingleAssetFluidType & AllClientsDataType = useStaticQuery(graphql`
    query {
  ...
  // demo video links
  const demoVideoLinksData: Array<string> = [
    demoVideoLink_1,
    demoVideoLink_2,
    demoVideoLink_3,
    demoVideoLink_4,
  ...
  // problem card data
  const problemStatementData: Array<string> = [
    problem_1,
    problem_2,
    problem_3,
    problem_4,
  ...
  // solution card data
  const solutionStatementData: Array<string> = [
    solution_1,
    solution_2,
    solution_3,
    solution_4,
  ...
  // frontend tech used
  const frontendTechData: Array<string> = [
    frontendTech_1,
    frontendTech_2,
    frontendTech_3,
    frontendTech_4,
  ...
  // backend tech used
  const backendTechData: Array<string> = [
    backendTech_1,
    backendTech_2,
    backendTech_3,
    backendTech_4,
          ...
          <div className="row">
            <main role="main" className="col-md-12 ml-sm-auto col-lg-12 col-xl-12 px-0 py-0">
              <div className="parallax-window shadow-sm">
                <div className="container-fluid">
                  ...
                  <div className="text-center rounded-0 border-0" id="project-main">
                    ...
                    <h5 className="py-3 text-wrap proect-details-desc">{projectCardDescription}</h5>
                    {tagline ? <q className="proect-details-desc">{tagline}</q> : null}
                  </div>
                  <div
                    ...
                    } align-content-start align-items-center py-2 py-md-5 mx-md-2`}
                  >
                    <div className="col">
                      <div className="media client-details-wrapper d-block d-sm-block d-md-flex">
                        ...
                        <div className="media-body pt-5 pb-2 py-md-0 d-flex align-self-stretch justify-content-between flex-column">
                          ...
                          <span
                            className={`badge rounded-pill bg-${setProjectCategoryBackgroundClass(
                              sector as ProjectCateoryType,
                            )} px-2 py-2 mb-2 text-${setProjectCategoryColorClass(
                              sector as ProjectCateoryType,
                            )}`}
                          >
                            {sector}
                        ...
                        <div className="media">
                          {demoVideoLinksData.length > 0 ? (
                            <div className="media-body video-wrapper justify-content-md-start justify-content-sm-center">
                              ...
                              <div className="wrap demo-video-wrapper d-flex align-items-baseline justify-content-md-start justify-content-center">
                                {demoVideoLinksData.map(
                                  (demoLink, index): JSX.Element => (
                                    <a key={index} target="_blank" href={demoLink}>
                                      <i className="fa fa-youtube-play px-md-3 px-2 play-demo-icon" />
                                      <p className="text-center text-dark video-text font-weight-bold">
                                        Video-{index + 1}
                                      </p>
                                    </a>
                                  ),
                          ...
                          <div className="media-body justify-content-center justify-content-md-start links-section">
                            ...
                            <div className="row d-flex align-items-start justify-content-md-start justify-content-lg-start justify-content-xl-start justify-content-xxl-start align-items-baseline justify-content-center">
                              ...
                              {appStoreLink ? (
                                <div
                                  className={`badge-wrapper col justify-content-xxl-start d-flex ${
                                    location.pathname ===
                                    '/OurWork/Bhagwati-Rice-&-Agro-Industries_Product-Authenticity-Verification-Platform'
                                      ? 'mt-2'
                                      : ''
                              ...
                              {googlePlayLink2 ? (
                                <div
                                  className={`badge-wrapper-xxl col justify-content-xxl-start justify-content-xl-start d-flex ${
                                    location.pathname ===
                                    '/OurWork/Bhagwati-Rice-&-Agro-Industries_Product-Authenticity-Verification-Platform'
                                      ? 'mt-2'
                                      : ''
              ...
              >
                <div className="col mb-4">
                  <div className="card work-card h-100 mx-md-5 shadow">
                    ...
                    <div className="card-body">
                      <h4 className="section-title text-center card-title pb-5">Problem</h4>
                ...
                <div className="col mb-4">
                  <div className="card work-card h-100 mx-md-5 shadow">
                    ...
                    <div className="card-body">
                      <h4 className="section-title text-center card-title pb-5">Solution</h4>
                      <ul className="list-group list-group-flush">
                        ...
                        <div className="row">
                          {frontendTechData.map((iconName, index) => (
                            <div className="col d-inline" key={index}>
                              ...
                              <span className="text-capitalize text-center mt-2 tech-icon-text">
                                {iconName.split('.')[0]}
                              </span>
                            </div>
                          ))}
                      ...
                      <div className="col">
                        ...
                        <div className="row">
                          {backendTechData.map((iconName, index) => (
                            <div className="col d-inline" key={index}>
                              <TechStackLogo techLogo={iconName} />
                              <span className="text-capitalize tech-icon-text mt-1">
                                {iconName.split('.')[0]}
                              </span>
                            </div>
                          ))}
              ...
              <section className="pb-5 pb-md-4">
                <div className="container-fluid">
                  <h4 className="section-title text-center my-3">Other Work</h4>
                  <Swiper
                    className="h-100"
                    id="otherWorksSlider"
                    {...defaultSliderConfig}
                  ...
                  >
                    {allClientsDataCsv &&
                      Array.isArray(allClientsDataCsv.edges) &&
                      allClientsDataCsv.edges.length > 0 &&
                      allClientsDataCsv.edges
                        .filter((clientData) => {
              ...
              <section>
                <div className="footer career-home-footer bg-transparent">
                  <div className="footer-content bg-transparent justify-content-center justify-content-md-end px-3">
                    <a href="https://www.freepik.com/vectors/infographic" className="text-dark">
