...
const Header: React.FC<LocationProps> = ({ location }) => {
  return (
    ...
    >
      ...
      <div className={`col-auto primary-nav-item ${location.pathname === '/Services/DigitalTransformation/' || location.pathname === '/Services/AppDev/' || location.pathname === '/Services/DevOps/' || location.pathname === '/Services/Startups/' ? 'primary-nav-active' : ''}`}>
