            ...
            <div className="card work-card h-100">
                    ...
                    </div>
                {
                    allClientImages.allFile.edges.filter((img) => {
                        ...
                        <GatsbyImage className="card-img mt-4" style={{height: '7rem'}} imgStyle={{height: clientLogo === 'bizminder.png' ? '4.2rem' : '6.2rem', objectFit: 'contain'}} key={imgData.node.base} alt={imgData.node.base.split('.')[0]} fluid={imgData.node.childImageSharp.fluid} />
                    ))
                }
